...
const NewTask = ({data}) => {
  ...
  return (
    <div className=" relative flex-shrink-0 h-full w-[350px] rounded-xl bg-black-400">
      <div>
        <div className="flex justify-between px-5 py-2 text-white text-xl font-semibold">
          <h4 className="bg-red-600 p-1 rounded-md">{data.category} this oneeee</h4>{" "}
          <h2>{data.date}</h2>
        </div>
      ...
      <div className="flex justify-evenly px-5 py-2 mt-5 gap-1 text-white text-s font-semibold absolute bottom-7">
